...
describe('Positive scenarios', () => {
    describe('inDirectory', () => {
        describe('should', () => {
            describe('haveName', () => {
                test(`check - 'repositories' should have name '*Repository*'`, async () => {
        ...
        describe('shouldNot', () => {
            describe('haveName', () => {
                test(`check - 'domain' should not have name '*MamaMia*'`, async () => {
                    includeAndExcludeScenarios.forEach(async ([includeMatcher, excludeFilesPattern]) => {
                        const options: Options = {
                            mimeTypes: ['**/*.js'],
                            includeMatcher: [...includeMatcher],
                ...
                test(`check - 'use-cases' should not have name '*Repository*'`, async () => {
                    includeAndExcludeScenarios.forEach(async ([includeMatcher, excludeFilesPattern]) => {
                        const options: Options = {
                            mimeTypes: ['**/*.js'],
                            includeMatcher: [...includeMatcher],
...
describe('Negative scenarios', () => {
    describe('inDirectory', () => {
        describe('shouldNot', () => {
            describe('haveName', () => {
                test(`check - 'repositories' should not have name '*Repository*'`, async () => {
                    includeAndExcludeScenarios.forEach(async ([includeMatcher, excludeFilesPattern]) => {
                        const options: Options = {
                            mimeTypes: ['**/*.js'],
                            includeMatcher: [...includeMatcher],
...
describe('Edge scenarios', () => {
    describe('inDirectory', () => {
        describe('should', () => {
            describe('haveName', () => {
                test(`check - domain should have name ""`, async () => {
                    includeAndExcludeScenarios.forEach(async ([includeMatcher, excludeFilesPattern]) => {
                        const options: Options = {
                            mimeTypes: ['**/*.ts'],
                            includeMatcher: [...includeMatcher],
        ...
        describe('shouldNot', () => {
            describe('haveName', () => {
                test(`check - domain should not have name ""`, async () => {
                    includeAndExcludeScenarios.forEach(async ([includeMatcher, excludeFilesPattern]) => {
                        const options: Options = {
                            mimeTypes: ['**/*.ts'],
                            includeMatcher: [...includeMatcher],
