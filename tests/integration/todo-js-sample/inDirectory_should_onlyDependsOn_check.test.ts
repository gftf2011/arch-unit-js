...
describe.skip('should.onlyDependsOn scenarios', () => {
        ...
        test('"use-cases" should only depend on "infra" - should FAIL', async () => {
            for (const [includeMatcher] of includeMatchers) {
                ...
                try {
                    ...
                    expect(errorMessage).toContain(`Violation - Rule: project files in directory '**/use-cases/**' should only depends on '[**/infra/**]'\n\n`);
        ...
        test('"main" should only depend on "domain" and "use-cases" - should FAIL (has "infra" too)', async () => {
            for (const [includeMatcher] of includeMatchers) {
                ...
                try {
                    ...
                    expect(errorMessage).toContain(`Violation - Rule: project files in directory '**/main/**' should only depends on '[**/use-cases/**, **/domain/**]'\n\n`);
    ...
    describe('Edge scenarios', () => {
        ...
        test(`must throw error if file path is not being reached by the 'includeMatcher'`, async () => {
            ...
            try {
                ...
                expect(errorMessage).toContain(`Violation - Rule: project files in directory '**/domain/**' should only depends on '[**/infra/**]'\n\n`);
