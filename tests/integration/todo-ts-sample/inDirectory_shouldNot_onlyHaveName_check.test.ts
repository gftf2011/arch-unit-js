      ...
      for (const [includeMatcher] of includeMatchers) {
        ...
        try {
          ...
          expect(errorMessage).toContain(
            `Violation - Rule: project files in directory '**/entities/**' should not only have name '*.ts'\n\n`,
          );
    ...
    test('"infra repositories" should not only have name "*Repository.ts" - should FAIL', async () => {
      for (const [includeMatcher] of includeMatchers) {
        ...
        try {
          ...
          expect(errorMessage).toContain(
            `Violation - Rule: project files in directory '**/infra/repositories/**' should not only have name '*Repository.ts'\n\n`,
          );
          expect(errorMessage).toContain(
    ...
    test('"main" should not only have name "app.ts" - should FAIL', async () => {
      for (const [includeMatcher] of includeMatchers) {
        ...
        try {
          ...
          expect(errorMessage).toContain(
            `Violation - Rule: project files in directory '**/main/**' should not only have name 'app.ts'\n\n`,
          );
    ...
    test('incorrect extension', async () => {
      for (const [includeMatcher] of includeMatchers) {
        ...
        try {
          ...
          expect(errorMessage).toContain(
            `Violation - Rule: project files in directory '**/entities/**' should not only have name '*Todo.ts'\n\n`,
          );
          expect(errorMessage).toContain(
